<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActiveWH.aspx.cs" Inherits="WMS1._0.WebPages.ActiveWH" %>
                ...
                <asp:GridView ID="gvWH" runat="server" Width="90%" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Select">
                            <ItemTemplate>
                                <asp:CheckBox runat="server" ID="cbwh" AutoPostBack="false" Checked='<%# Eval("IsActive").ToString()=="True" ? true : false %>'/>
                                
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="Company Code" DataField="CompanyCode" />
                        <asp:BoundField HeaderText="WHID/UserId" DataField="WHId" />
                        ...
                        <asp:TemplateField HeaderText="Expiry Date">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtExpiryDate"  Text='<%# Eval("ExpiryDate").ToString()%>'/>                                
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Password">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtPassword"  Text='<%# Eval("Password").ToString()%>'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
